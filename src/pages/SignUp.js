  ...
  const submitHandler = async (e) => {
    ...
    if (email && password && (confirmPass || isUser)) {
      if (password === confirmPass || isUser) {
        ...
        if (isUser) {
          url =
            'https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyBUKWtuc6mChahG1mskYlsoKXzaEc-y9ME'
        } else {
          url =
            'https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyBUKWtuc6mChahG1mskYlsoKXzaEc-y9ME'
        }
